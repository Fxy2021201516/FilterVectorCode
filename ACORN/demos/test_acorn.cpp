...
int main(int argc, char *argv[])
{
   ...
   { // parse arguments
      ...
      if (dataset != "sift1M" && dataset != "sift1M_test" &&
          ...
          dataset != "words" && dataset != "MTG" && dataset != "arxiv" && dataset != "captcha" && dataset != "TimeTravel" && dataset != "russian" && dataset != "bookimg" && dataset != "app_reviews" && dataset != "amazing_file" && dataset != "celeba") // TODO
      {
