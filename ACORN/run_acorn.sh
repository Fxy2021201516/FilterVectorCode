...
export ACORN_BUILD_DIR="/home/fengxiaoyao/1023FilterVector/build_${dataset}"
...
UNG_BUILD_DIR_FOR_GT="/home/fengxiaoyao/1023FilterVector/build_para/ung"
...
if [[ "$mode" == "search" || "$mode" == "all" ]]; then
   ...
   if [ ! -f "$gt_bin_path" ]; then
      ...
      # =========================================================================
      REORDER_DIR="/home/fengxiaoyao/1023FilterVector/FilterVectorResults/Reviews/Index/M32_LB100_alpha1.2_C6_EP16_AN288065_AM32_AMB64_AG80/index_files"
